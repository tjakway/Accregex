#from https://github.com/getify/JSON.minify/blob/python/json_minify/__init__.py
#MIT licensed
#see https://github.com/getify/JSON.minify/blob/python/README.md https://github.com/getify/JSON.minify/blob/python/PORTING.md
#for license explanation
